...
class ViewHolderCurrentYear(private val itemView: View, private val callback: TopOpenCallback, private val picasso: Picasso)
    ...
    fun bind(content: ContentItemPage){
        ...
        itemView.setOnClickListener{ callback.onOpen(content = content.content) }
        picasso
